...
// v1. Metiendo un String en el constructor
...
abstract class Persona
{
    ...
    protected function __construct(String $nombre, int $edad, String $asignatura)
    {
        $this->nombre = $nombre;
        $this->edad = $edad;
...
class Alumno extends Persona implements Acciones1, Acciones2
{
    ...
    public function __construct(String $nombre, int $edad, String $asignatura, bool $matriculaPagada)
    {
...
<body>
    <?php
    // Script principal
    $alumna = new Alumno("Maria", 34, "Curso PHP Avanzado", true);
    echo $alumna;
